...
//window.onload = function () {
  ...
  `
    ...
    // console.log(orderItem.orderId,orderItem.itemId);
...
//          console.log(datePlaced);
      ...
      let progresavredge=
        ((((new Date()-datePlaced)/(1000 * 60 * 60 * 24))/((arrivingDate-datePlaced)/(1000 * 60 * 60 * 24)))*100 ).toFixed(2);
    ;


    //  console.log(progresavredge);
    //   console.log(pl);
    //   console.log(arrivingDate);
    //   console.log(arrivingDate);
    //   console.log(arrivingDate);
