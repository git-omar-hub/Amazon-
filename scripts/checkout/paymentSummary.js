...
return { productPriceCents,shippingPriceCents,totalBeforeTaxCents,taxCents,totalCents}
}

export function renderPaymentSummary(){


const{ productPriceCents,shippingPriceCents,totalBeforeTaxCents,taxCents,totalCents}=orderTotalPrice();
